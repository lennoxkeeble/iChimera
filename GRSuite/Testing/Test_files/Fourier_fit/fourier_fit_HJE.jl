...
function compute_fit(nHarm::Int64, nPoints::Int64, index1::Int64, index2::Int64, a::Float64, p::Float64, e::Float64, θi::Float64, M::Float64, m::Float64, kerrReltol::Float64, kerrAbstol::Float64)
    ...
    # carry out fit
    @time Ω, ffit, fitted_data = FourierFit.fourier_fit(xdata, ydata, Ω[1], Ω[2], Ω[3], nHarm, p0=p0)
...
plot_N_2_name="Mij_$(index1)_$(index2)_fit_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_2_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
...
error_plot_fit_N_2 = scatter([xdata_2[index1_points], xdata_2[index2_points]], errors_fit_N_2, xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        ...
        annotate!(minimum(xdata_2[index1_points]) + (maximum(xdata_2[index1_points])-minimum(xdata_2[index1_points]))*0.1, 5e6, Plots.text(L"N=2", :center, 12))

yticks!(error_plot_fit_N_2, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
...
error_plot_derivs_N_2 = scatter([xdata_2[index1_points], xdata_2[index2_points]], errors_deriv_N_2, xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        ...
        ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
        markersize=ms, markerstrokewidth=markerstrokewidth,
        ylims=(1e-8,1e8), dpi=600, yscale=:log10, markershape=[shapes[1] shapes[2]], color=[colors[1] colors[2]], alpha=[alpha[1] alphas[2]])
        vline!([xdata_2[index2_points][points[index2_points] ÷ 2]], label=false, linestyle=:dash)
        # annotate!(minimum(xdata_2[index1_points]) + (maximum(xdata_2[index1_points])-minimum(xdata_2[index1_points]))*0.1, 5e6, Plots.text(L"N=2", :center, 12))

yticks!(error_plot_derivs_N_2, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
display(error_plot_derivs_N_2)

Mij_error_plot_N_2=plot(error_plot_fit_N_2, error_plot_derivs_N_2, layout=(1, 2), size=(1600, 400))
plot_name="Mij_$(index1)_$(index2)_error_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_2_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
savefig(Mij_error_plot_N_2, plot_path * plot_name)


### N=3 harmonics ####
# plotting fits for "by-eye" comparison #
plot_N_3_Mij_fit1 = plot([xdata_3[index1_points], xdata_3[index1_points]], [ydata_3[index1_points][1], fit_data_3[index1_points][1]], label=["Analytic" "Fit" "Fourier Fit"],
xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize)
annotate!(plot_N_3_Mij_fit1, minimum(xdata_3[index1_points]) + (maximum(xdata_3[index1_points])-minimum(xdata_3[index1_points]))*0.1, 
minimum(ydata_3[index1_points][1]) + (maximum(ydata_3[index1_points][1])-minimum(ydata_3[index1_points][1]))*0.9,
Plots.text(L"N=3,\;n_{\mathrm{p}}=%$(points[index1_points])", :left, 12))

plot_N_3_Mij_fit2 = plot([xdata_3[index2_points], xdata_3[index2_points]], [ydata_3[index2_points][1], fit_data_3[index2_points][1]],
xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize, legend=false)
annotate!(plot_N_3_Mij_fit2, minimum(xdata_3[index2_points]) + (maximum(xdata_3[index2_points])-minimum(xdata_3[index2_points]))*0.1, 
minimum(ydata_3[index2_points][1]) + (maximum(ydata_3[index2_points][1])-minimum(ydata_3[index2_points][1]))*0.9,
Plots.text(L"n_{\mathrm{p}}=%$(points[index2_points])", :left, 12))

plot_N_3_Mij2_fit1 = plot([xdata_3[index1_points], xdata_3[index1_points]], [ydata_3[index1_points][2], fit_data_3[index1_points][2]], label=["Analytic" "Fit" "Fourier Fit"],
xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize)
annotate!(plot_N_3_Mij2_fit1, minimum(xdata_3[index1_points]) + (maximum(xdata_3[index1_points])-minimum(xdata_3[index1_points]))*0.1, 
minimum(ydata_3[index1_points][2]) + (maximum(ydata_3[index1_points][2])-minimum(ydata_3[index1_points][2]))*0.9,
Plots.text(L"n_{\mathrm{p}}=%$(points[index1_points])", :left, 12), legend=false)

plot_N_3_Mij2_fit2 = plot([xdata_3[index2_points], xdata_3[index2_points]], [ydata_3[index2_points][2], fit_data_3[index2_points][2]],
xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize, legend=false)
annotate!(plot_N_3_Mij2_fit2, minimum(xdata_3[index2_points]) + (maximum(xdata_3[index2_points])-minimum(xdata_3[index2_points]))*0.1, 
minimum(ydata_3[index2_points][2]) + (maximum(ydata_3[index2_points][2])-minimum(ydata_3[index2_points][2]))*0.9,
Plots.text(L"n_{\mathrm{p}}=%$(points[index2_points])", :left, 12))

Mij_N_3_fit_plot=plot(plot_N_3_Mij_fit1, plot_N_3_Mij_fit2, plot_N_3_Mij2_fit1, plot_N_3_Mij2_fit2, layout=(2, 2), size=(1600, 800))
plot_N_3_name="Mij_$(index1)_$(index2)_fit_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_3_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
savefig(Mij_N_3_fit_plot, plot_path * plot_N_3_name)

# plotting errors (i.e., percentage difference) #
errors_fit_N_3 = [@.(100 * abs((ydata_3[index1_points][1]-fit_data_3[index1_points][1])/ydata_3[index1_points][1])), @.(100 * abs((ydata_3[index2_points][1]-fit_data_3[index2_points][1])/ydata_3[index2_points][1]))]; # error in fit itself
errors_deriv_N_3 = [@.(100 * abs((ydata_3[index1_points][2]-fit_data_3[index1_points][2])/ydata_3[index1_points][2])), @.(100 * abs((ydata_3[index2_points][2]-fit_data_3[index2_points][2])/ydata_3[index2_points][2]))]; # error in derivative

# plotting deviations of the 0th derivative #
error_plot_fit_N_3 = scatter([xdata_3[index1_points], xdata_3[index2_points]], errors_fit_N_3, xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        framsetyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=bottom_margin,
        legend=:topright, foreground_color_legend = nothing, background_color_legend = nothing, xtickfontsize = xtickfontsize,
        ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
        markersize=ms, markerstrokewidth=markerstrokewidth,
        ylims=(1e-8,1e8), dpi=600,
        label=[L"n_{\mathrm{p}}=%$(points[index1_points])" L"n_{\mathrm{p}}=%$(points[index2_points])"], yscale=:log10, markershape=[shapes[1] shapes[2]], color=[colors[1] colors[2]], alpha=[alpha[1] alphas[2]])
        vline!([xdata_3[index2_points][points[index2_points] ÷ 2]], label=false, linestyle=:dash)
        annotate!(minimum(xdata_3[index1_points]) + (maximum(xdata_3[index1_points])-minimum(xdata_3[index1_points]))*0.1, 5e6, Plots.text(L"N=3", :center, 12))

yticks!(error_plot_fit_N_3, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
display(error_plot_fit_N_3)

# plotting deviations of the 2nd derivative #

error_plot_derivs_N_3 = scatter([xdata_3[index1_points], xdata_3[index2_points]], errors_deriv_N_3, xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        framsetyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=bottom_margin,
        legend=false, foreground_color_legend = nothing, background_color_legend = nothing, xtickfontsize = xtickfontsize,
        ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
        markersize=ms, markerstrokewidth=markerstrokewidth,
...
yticks!(error_plot_derivs_N_3, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
display(error_plot_derivs_N_3)

Mij_error_plot_N_3=plot(error_plot_fit_N_3, error_plot_derivs_N_3, layout=(1, 2), size=(1600, 400))
plot_name="Mij_$(index1)_$(index2)_error_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_3_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
savefig(Mij_error_plot_N_3, plot_path * plot_name)

### N=4 harmonics ####
# plotting fits for "by-eye" comparison #
plot_N_4_Mij_fit1 = plot([xdata_4[index1_points], xdata_4[index1_points]], [ydata_4[index1_points][1], fit_data_4[index1_points][1]], label=["Analytic" "Fit" "Fourier Fit"],
xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize)
annotate!(plot_N_4_Mij_fit1, minimum(xdata_4[index1_points]) + (maximum(xdata_4[index1_points])-minimum(xdata_4[index1_points]))*0.1, 
minimum(ydata_4[index1_points][1]) + (maximum(ydata_4[index1_points][1])-minimum(ydata_4[index1_points][1]))*0.9,
Plots.text(L"N=4,\;n_{\mathrm{p}}=%$(points[index1_points])", :left, 12))

plot_N_4_Mij_fit2 = plot([xdata_4[index2_points], xdata_4[index2_points]], [ydata_4[index2_points][1], fit_data_4[index2_points][1]],
xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize, legend=false)
annotate!(plot_N_4_Mij_fit2, minimum(xdata_4[index2_points]) + (maximum(xdata_4[index2_points])-minimum(xdata_4[index2_points]))*0.1, 
minimum(ydata_4[index2_points][1]) + (maximum(ydata_4[index2_points][1])-minimum(ydata_4[index2_points][1]))*0.9,
Plots.text(L"n_{\mathrm{p}}=%$(points[index2_points])", :left, 12))

plot_N_4_Mij2_fit1 = plot([xdata_4[index1_points], xdata_4[index1_points]], [ydata_4[index1_points][2], fit_data_4[index1_points][2]], label=["Analytic" "Fit" "Fourier Fit"],
xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize)
annotate!(plot_N_4_Mij2_fit1, minimum(xdata_4[index1_points]) + (maximum(xdata_4[index1_points])-minimum(xdata_4[index1_points]))*0.1, 
minimum(ydata_4[index1_points][2]) + (maximum(ydata_4[index1_points][2])-minimum(ydata_4[index1_points][2]))*0.9,
Plots.text(L"n_{\mathrm{p}}=%$(points[index1_points])", :left, 12), legend=false)

plot_N_4_Mij2_fit2 = plot([xdata_4[index2_points], xdata_4[index2_points]], [ydata_4[index2_points][2], fit_data_4[index2_points][2]],
xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize, legend=false)
annotate!(plot_N_4_Mij2_fit2, minimum(xdata_4[index2_points]) + (maximum(xdata_4[index2_points])-minimum(xdata_4[index2_points]))*0.1, 
minimum(ydata_4[index2_points][2]) + (maximum(ydata_4[index2_points][2])-minimum(ydata_4[index2_points][2]))*0.9,
Plots.text(L"n_{\mathrm{p}}=%$(points[index2_points])", :left, 12))

Mij_N_4_fit_plot=plot(plot_N_4_Mij_fit1, plot_N_4_Mij_fit2, plot_N_4_Mij2_fit1, plot_N_4_Mij2_fit2, layout=(2, 2), size=(1600, 800))
plot_N_4_name="Mij_$(index1)_$(index2)_fit_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_4_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
savefig(Mij_N_4_fit_plot, plot_path * plot_N_4_name)

# plotting errors (i.e., percentage difference) #
errors_fit_N_4 = [@.(100 * abs((ydata_4[index1_points][1]-fit_data_4[index1_points][1])/ydata_4[index1_points][1])), @.(100 * abs((ydata_4[index2_points][1]-fit_data_4[index2_points][1])/ydata_4[index2_points][1]))]; # error in fit itself
errors_deriv_N_4 = [@.(100 * abs((ydata_4[index1_points][2]-fit_data_4[index1_points][2])/ydata_4[index1_points][2])), @.(100 * abs((ydata_4[index2_points][2]-fit_data_4[index2_points][2])/ydata_4[index2_points][2]))]; # error in derivative

# plotting deviations of the 0th derivative #
error_plot_fit_N_4 = scatter([xdata_4[index1_points], xdata_4[index2_points]], errors_fit_N_4, xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        framsetyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=bottom_margin,
        legend=:topright, foreground_color_legend = nothing, background_color_legend = nothing, xtickfontsize = xtickfontsize,
        ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
        markersize=ms, markerstrokewidth=markerstrokewidth,
        ylims=(1e-8,1e8), dpi=600,
        label=[L"n_{\mathrm{p}}=%$(points[index1_points])" L"n_{\mathrm{p}}=%$(points[index2_points])"], yscale=:log10, markershape=[shapes[1] shapes[2]], color=[colors[1] colors[2]], alpha=[alpha[1] alphas[2]])
        vline!([xdata_4[index2_points][points[index2_points] ÷ 2]], label=false, linestyle=:dash)
        annotate!(minimum(xdata_4[index1_points]) + (maximum(xdata_4[index1_points])-minimum(xdata_4[index1_points]))*0.1, 5e6, Plots.text(L"N=4", :center, 12))

yticks!(error_plot_fit_N_4, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
display(error_plot_fit_N_4)

# plotting deviations of the 2nd derivative #

error_plot_derivs_N_4 = scatter([xdata_4[index1_points], xdata_4[index2_points]], errors_deriv_N_4, xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        framsetyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=bottom_margin,
        legend=false, foreground_color_legend = nothing, background_color_legend = nothing, xtickfontsize = xtickfontsize,
        ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
        markersize=ms, markerstrokewidth=markerstrokewidth,
...
yticks!(error_plot_derivs_N_4, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
display(error_plot_derivs_N_4)

Mij_error_plot_N_4=plot(error_plot_fit_N_4, error_plot_derivs_N_4, layout=(1, 2), size=(1600, 400))
plot_name="Mij_$(index1)_$(index2)_error_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_4_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
savefig(Mij_error_plot_N_4, plot_path * plot_name)
...
plot_N_5_name="Mij_$(index1)_$(index2)_fit_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_5_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
...
error_plot_fit_N_5 = scatter([xdata_5[index1_points], xdata_5[index2_points]], errors_fit_N_5, xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
        ...
        annotate!(minimum(xdata_5[index1_points]) + (maximum(xdata_5[index1_points])-minimum(xdata_5[index1_points]))*0.1, 5e6, Plots.text(L"N=5", :center, 12))

yticks!(error_plot_fit_N_5, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
...
yticks!(error_plot_derivs_N_5, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
display(error_plot_derivs_N_5)

Mij_error_plot_N_5=plot(error_plot_fit_N_5, error_plot_derivs_N_5, layout=(1, 2), size=(1600, 400))
plot_name="Mij_$(index1)_$(index2)_error_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_5_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
savefig(Mij_error_plot_N_5, plot_path * plot_name)

### N=6 harmonics ####
# # plotting fits for "by-eye" comparison #
# plot_N_6_Mij_fit1 = plot([xdata_6[index1_points], xdata_6[index1_points]], [ydata_6[index1_points][1], fit_data_6[index1_points][1]], label=["Analytic" "Fit" "Fourier Fit"],
# xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
# bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
# ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize)
# annotate!(plot_N_6_Mij_fit1, minimum(xdata_6[index1_points]) + (maximum(xdata_6[index1_points])-minimum(xdata_6[index1_points]))*0.1, 
# minimum(ydata_6[index1_points][1]) + (maximum(ydata_6[index1_points][1])-minimum(ydata_6[index1_points][1]))*0.9,
# Plots.text(L"N=6,\;n_{\mathrm{p}}=%$(points[index1_points])", :left, 12))

# plot_N_6_Mij_fit2 = plot([xdata_6[index2_points], xdata_6[index2_points]], [ydata_6[index2_points][1], fit_data_6[index2_points][1]],
# xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
# bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
# ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize, legend=false)
# annotate!(plot_N_6_Mij_fit2, minimum(xdata_6[index2_points]) + (maximum(xdata_6[index2_points])-minimum(xdata_6[index2_points]))*0.1, 
# minimum(ydata_6[index2_points][1]) + (maximum(ydata_6[index2_points][1])-minimum(ydata_6[index2_points][1]))*0.9,
# Plots.text(L"n_{\mathrm{p}}=%$(points[index2_points])", :left, 12))

# plot_N_6_Mij2_fit1 = plot([xdata_6[index1_points], xdata_6[index1_points]], [ydata_6[index1_points][2], fit_data_6[index1_points][2]], label=["Analytic" "Fit" "Fourier Fit"],
# xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
# bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
# ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize)
# annotate!(plot_N_6_Mij2_fit1, minimum(xdata_6[index1_points]) + (maximum(xdata_6[index1_points])-minimum(xdata_6[index1_points]))*0.1, 
# minimum(ydata_6[index1_points][2]) + (maximum(ydata_6[index1_points][2])-minimum(ydata_6[index1_points][2]))*0.9,
# Plots.text(L"n_{\mathrm{p}}=%$(points[index1_points])", :left, 12), legend=false)

# plot_N_6_Mij2_fit2 = plot([xdata_6[index2_points], xdata_6[index2_points]], [ydata_6[index2_points][2], fit_data_6[index2_points][2]],
# xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}", framestyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=
# bottom_margin, color=color, linewidth=linewidth, alpha=alpha, linestyle=linestyle, foreground_color_legend = nothing, background_color_legend = nothing, dpi=600, xtickfontsize = xtickfontsize,
# ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize, legend=false)
# annotate!(plot_N_6_Mij2_fit2, minimum(xdata_6[index2_points]) + (maximum(xdata_6[index2_points])-minimum(xdata_6[index2_points]))*0.1, 
# minimum(ydata_6[index2_points][2]) + (maximum(ydata_6[index2_points][2])-minimum(ydata_6[index2_points][2]))*0.9,
# Plots.text(L"n_{\mathrm{p}}=%$(points[index2_points])", :left, 12))

# Mij_N_6_fit_plot=plot(plot_N_6_Mij_fit1, plot_N_6_Mij_fit2, plot_N_6_Mij2_fit1, plot_N_6_Mij2_fit2, layout=(2, 2), size=(1600, 800))
# plot_N_6_name="Mij_$(index1)_$(index2)_fit_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_6_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
# savefig(Mij_N_6_fit_plot, plot_path * plot_N_6_name)

# # plotting errors (i.e., percentage difference) #
# errors_fit_N_6 = [@.(100 * abs((ydata_6[index1_points][1]-fit_data_6[index1_points][1])/ydata_6[index1_points][1])), @.(100 * abs((ydata_6[index2_points][1]-fit_data_6[index2_points][1])/ydata_6[index2_points][1]))]; # error in fit itself
# errors_deriv_N_6 = [@.(100 * abs((ydata_6[index1_points][2]-fit_data_6[index1_points][2])/ydata_6[index1_points][2])), @.(100 * abs((ydata_6[index2_points][2]-fit_data_6[index2_points][2])/ydata_6[index2_points][2]))]; # error in derivative

# # plotting deviations of the 0th derivative #
# error_plot_fit_N_6 = scatter([xdata_6[index1_points], xdata_6[index2_points]], errors_fit_N_6, xlabel=L"t", ylabel=L"M_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
#         framsetyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=bottom_margin,
#         legend=:topright, foreground_color_legend = nothing, background_color_legend = nothing, xtickfontsize = xtickfontsize,
#         ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
#         markersize=ms, markerstrokewidth=markerstrokewidth,
#         ylims=(1e-8,1e8), dpi=600,
#         label=[L"n_{\mathrm{p}}=%$(points[index1_points])" L"n_{\mathrm{p}}=%$(points[index2_points])"], yscale=:log10, markershape=[shapes[1] shapes[2]], color=[colors[1] colors[2]], alpha=[alpha[1] alphas[2]])
#         vline!([xdata_6[index2_points][points[index2_points] ÷ 2]], label=false, linestyle=:dash)
#         annotate!(minimum(xdata_6[index1_points]) + (maximum(xdata_6[index1_points])-minimum(xdata_6[index1_points]))*0.1, 5e6, Plots.text(L"N=6", :center, 12))

# yticks!(error_plot_fit_N_6, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
# display(error_plot_fit_N_6)

# # plotting deviations of the 2nd derivative #

# error_plot_derivs_N_6 = scatter([xdata_6[index1_points], xdata_6[index2_points]], errors_deriv_N_6, xlabel=L"t", ylabel=L"\ddot{M}_{%$(index1)%$(index2)}\,\mathrm{error}\,(\%)",
#         framsetyle=:box, left_margin=left_margin, right_margin=right_margin, top_margin=top_margin, bottom_margin=bottom_margin,
#         legend=false, foreground_color_legend = nothing, background_color_legend = nothing, xtickfontsize = xtickfontsize,
#         ytickfontsize = ytickfontsize, guidefontsize = guidefontsize, legendfontsize=legendfontsize,
#         markersize=ms, markerstrokewidth=markerstrokewidth,
...
# yticks!(error_plot_derivs_N_6, [1e-8, 1e-6, 1e-4, 1e-2, 1e0, 1e2, 1e4, 1e6, 1e8])
# display(error_plot_derivs_N_6)

# Mij_error_plot_N_6=plot(error_plot_fit_N_6, error_plot_derivs_N_6, layout=(1, 2), size=(1600, 400))
# plot_name="Mij_$(index1)_$(index2)_error_plot_a_$(a)_p_$(p)_e_$(e)_θi_$(round(θi; digits=3))_nHarm_6_nPoints_$(points[index1_points])_$(points[index2_points])_10_max.png"
# savefig(Mij_error_plot_N_6, plot_path * plot_name)