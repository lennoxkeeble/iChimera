#=
    ...
    In this module we write functions which compute the radiaction reaction potentials and their derivatives. See Eqs. 44-45 in arXiv:1109.0572v2.
    The long expressions have been copied from MMA.
